...
public class add_course extends javax.swing.JFrame {
   Connection conn = db_conn.conn();
    ...
    String course = jTextField1.getText().trim();
    String year = jTextField2.getText().trim();
    String description = jTextField3.getText().trim();
    
    if (course.isEmpty() || year.isEmpty() || description.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Please fill in all fields!");
        return;
    }

    try {
        String sql = "INSERT INTO courses (course_name, course_year, description) VALUES (?, ?, ?)";
        ...
        // Refresh the main table if Home is open
